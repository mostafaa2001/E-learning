...
const SolveExam = ({ course }) => {
    ...
    const str = '/api/indiv/' + individ + '/' + subid + '/solveExam'
    ...
    return (
        ...
        <div>
            ...
            {exams&&exams.map((ex) => (
                ...
                <div>
                    <br></br>
                    <button key={ex._id} onClick={event =>  window.location.href='/indiv/' + individ + '/' + subid + '/solveExam'+'/'+ex._id} >{ex.Exam_Name}</button>
                    <br></br>
                </div>
