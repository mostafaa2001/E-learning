       ...
       if(Password1 === "" || Password2 === ""){
        ...
        if(Password1 == Password2){
            ...
            if(localStorage.getItem('type') === 'instructor'){
                await fetch('/api/instructor/password/' + localStorage.getItem('id'), {
                    method: 'PATCH',
            ...
            else if(localStorage.getItem('type') === 'indiv'){
                await fetch('/api/indiv/password/' + localStorage.getItem('id'), {
                    method: 'PATCH',
            ...
            else if(localStorage.getItem('type') === 'coorp'){
                await fetch('/api/coorp/password/' + localStorage.getItem('id'), {
                    method: 'PATCH',
    ...
    return (
        <div>
            ...
            <MDBContainer className="p-3 my-5 d-flex flex-column w-50">
                ...
                {localStorage.getItem('id') !== null  ? <MDBContainer className="p-3 my-5 d-flex flex-column w-50">
